...
import blogImage from "@/assets/blog/gestao-financeira.jpg";
  ...
  <>
    ...
    <article className="min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-4 py-12 space-y-8">
        ...
        <img src={blogImage} alt="Gestão financeira para profissionais de saúde com gráficos e calculadora" width={1200} height={672} className="rounded-xl w-full object-cover" loading="eager" />
